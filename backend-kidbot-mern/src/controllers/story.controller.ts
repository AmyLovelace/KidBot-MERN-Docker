 ...
 */
  async create(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      res.status(201).send(createdStory); // Devuelve la historia creada en la respuesta con código 201 (creado)
    } catch (err) {
      console.error('Error al crear la historia:', err);
      res.status(500).send({ error: 'Error al crear la historia' }); 
  ...
  async findById(req: Request, res: Response): Promise<any> {
    ...
    try {
      ...
      res.send(story); // Devuelve la historia encontrada en la respuesta
    } catch (err) {
      console.error('Error al obtener la historia:', err);
      res.status(500).send({ error: 'Error al obtener la historia' });
    }
  }
  ...
  async find(req: Request, res: Response): Promise<any> {
    try {
      ...
      res.send(stories); // Devuelve todas las historias encontradas en la respuesta
    } catch (err) {
  ...
  async findBy(req: Request, res: Response): Promise<any> {
    ...
    try {
      ...
      res.send(stories); // Devuelve las historias encontradas en la respuesta
    } catch (err) {
      console.error('Error al obtener los usuarios:', err);
      res.status(500).send({ error: 'Error al obtener los usuarios' });
    }
  ...
  async update(req: Request, res: Response): Promise<any> {
    ...
    try {
      ...
      res.status(500).send({ error: 'Error al actualizar la historia' });
    }
  }
  */
  ...
  async delete(req: Request, res: Response): Promise<any> {
    ...
    try {
      ...
      res.status(500).send({ error: 'Error al eliminar la historia' });
    }
  }
}
